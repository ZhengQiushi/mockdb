...
func (c *sQLInfoServiceClient) SendSQLInfo(ctx context.Context, in *SQLInfoRequest, opts ...grpc.CallOption) (*SQLInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, SQLInfoService_SendSQLInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSQLInfoServiceServer must be embedded to have
...
func (UnimplementedSQLInfoServiceServer) testEmbeddedByValue()                        {}
...
func RegisterSQLInfoServiceServer(s grpc.ServiceRegistrar, srv SQLInfoServiceServer) {
	// If the following call pancis, it indicates UnimplementedSQLInfoServiceServer was
